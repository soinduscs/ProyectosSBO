...
namespace Soindus.AddOnFactoringCob.Comun
{
    ...
    {
        public static Comun.Message Result = new Comun.Message();
        ...
        public static Comun.Message Errores(int errorCode, string errMsj)
        {
            string Msj = "";
            try
            {
        ...
        public static Comun.Message Exitos(int SuccesCode, string Msj)
        {
            try
            {
                switch (SuccesCode)
        ...
        private static Comun.Message MostrarMsjWF(int id, string Msj, bool tipo)
        {
            Comun.Message response = new Comun.Message();
            response.Id = id;
