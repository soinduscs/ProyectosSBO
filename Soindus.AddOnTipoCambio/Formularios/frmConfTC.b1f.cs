...
{
    [FormAttribute("Soindus.AddOnTipoCambio.Formularios.frmConfTC", "Formularios/frmConfTC.b1f")]
    class frmConfTC : UserFormBase
    {
        ...
        {
            oForm = ((SAPbouiCOM.Form)(Application.SBO_Application.Forms.Item("frmConfTC")));
        ...
        private static void GuardarCambios()
        {
            ...
            try
            {
                ...
                oGeneralService = oCompanyService.GetGeneralService("SO_TCCONF");
                ...
                if (existeconf)
                {
                    ...
                    oGeneralData.SetProperty("Name", "Configuración Tipos de Cambio");
