...
namespace Soindus.AddOnTipoCambio.BCC
{
    ...
    public partial class GetSeriesResponse
    {
        public static GetSeriesResponse FromJson(string json) => JsonConvert.DeserializeObject<GetSeriesResponse>(json, Soindus.AddOnTipoCambio.BCC.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this GetSeriesResponse self) => JsonConvert.SerializeObject(self, Soindus.AddOnTipoCambio.BCC.Converter.Settings);
    }
