...
namespace Soindus.AddOnTipoCambio.SBO
{
    public class EstructuraSBO
    {
        ...
        private static void CargarTablas()
        {
            try
            {
                CreaTablaMD("SO_TIPOCAMBIO", "Actualización Tipo de Cambio", SAPbobsCOM.BoUTBTableType.bott_NoObjectAutoIncrement);
                CreaTablaMD("SO_TCCONF", "Configuración Tipo de Cambio", SAPbobsCOM.BoUTBTableType.bott_MasterData);
            }
            catch (Exception e)
            {
        ...
        {
            ////Campos de usuario para tabla tipocambio
            CreaCampoMD("@SO_TIPOCAMBIO", "CODIGO", "Código Serie", 50, SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null);
            Local.ValorValido[] valoresSINO = new Local.ValorValido[]
                { new Local.ValorValido("Y", "Si"),
                  new Local.ValorValido("N", "No")};
            CreaCampoMD("@SO_TIPOCAMBIO", "ESFIJA", "Es Fija", 1, SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.BoYesNoEnum.tNO, "N", valoresSINO, null);
            CreaCampoMD("@SO_TIPOCAMBIO", "ESFACTOR", "Es Factorizable", 1, SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.BoYesNoEnum.tNO, "N", valoresSINO, null);
            CreaCampoMD("@SO_TIPOCAMBIO", "CODIGOFACTOR", "Código Factor", 50, SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null);
            CreaCampoMD("@SO_TIPOCAMBIO", "PORTADOR", "Portador", 50, SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null);
            ////Campos de usuario para tabla configuración
            CreaCampoMD("@SO_TCCONF", "TOKEN", "Token de Conexión Portador TC", 254, SAPbobsCOM.BoFieldTypes.db_Alpha, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.BoYesNoEnum.tNO, null, null, null);
        }
        ...
        private static void CargarUDO()
        {
            try
            {
                CreaUDOMD("SO_TCCONF", "", "SO_TCCONF", "Conf. Tipos de Cambio Soindus", SAPbobsCOM.BoUDOObjType.boud_MasterData);
            }
            catch (Exception e)
            {
