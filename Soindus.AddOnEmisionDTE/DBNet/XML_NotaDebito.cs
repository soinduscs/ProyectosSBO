    ...
    public class XML_NotaDebito
    {
        public putCustomerETDLoad Generar(int DocEntry)
        {
            ...
            if (!oRec.EoF)
            {
                ...
                emision.Encabezado.camposEncabezado.TipoDTE = "56";
                ...
                if (Resumida)
                {
                    ...
                    string glosaGuias = "SEGUN GUIA N° ";
                    ...
                    if (countguias > 0)
                    {
                        ...
                        detalle.Detalles.NmbItem = "GE";
                        detalle.Detalles.DscItem = glosaGuias.ToString();
