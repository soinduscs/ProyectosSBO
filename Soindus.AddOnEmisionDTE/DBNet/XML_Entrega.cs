    ...
    public class XML_Entrega
    {
        public putCustomerETDLoad Generar(int DocEntry)
        {
            ...
            query = @"Select ""Indicator"", ""DocNum"", ""DocDate"", ""TaxDate"", ""DocTotal"",
                            ...
                            from ""ODLN"" INNER JOIN ""OSLP"" ON ""ODLN"".""SlpCode"" = ""OSLP"".""SlpCode""
            ...
            if (!oRec.EoF)
            {
                ...
                emision.Encabezado.camposEncabezado.TipoDespacho = oRec.Fields.Item("U_TIPODESP").Value.ToString();
                emision.Encabezado.camposEncabezado.IndTraslado = oRec.Fields.Item("U_TIPOTRAS").Value.ToString();
                ...
                query = @"Select top 1 * from ""DLN1"" where ""DocEntry"" = " + DocEntry + "";
                oRecG.DoQuery(query);
                ...
                {
                    query = @"Select
                            ""DLN1"".""ItemCode"" as ""ItemCode"",
                            ""DLN1"".""Dscription"" as ""Dscription"",
                            ""DLN1"".""Quantity"" as ""Quantity"",
                            ""DLN1"".""Price"" as ""Price"",
                            ""DLN1"".""DiscPrcnt"" as ""DiscPrcnt"",
                            (""DLN1"".""DiscPrcnt"" * ""DLN1"".""PriceBefDi"" * ""DLN1"".""Quantity"" /100) as ""MtoDescuento"",
                            ""DLN1"".""LineTotal"" as ""LineTotal"",
                            ""DLN1"".""PackQty"" as ""PackQty"",
                            ""DLN1"".""SubCatNum"" as ""SubCatNum"",
