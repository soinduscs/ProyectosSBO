    ...
    public class XML_Entrega
    {
        public Documento Generar(int DocEntry)
        {
            ...
            if (!oRec.EoF)
            {
                ...
                emision.Encabezado.IdDoc.TipoDTE = "52";
                ...
                emision.Encabezado.IdDoc.TipoDespacho = oRec.Fields.Item("U_SO_TIPODESP").Value.ToString();
                emision.Encabezado.IdDoc.IndTraslado = oRec.Fields.Item("U_SO_TIPOTRAS").Value.ToString();
