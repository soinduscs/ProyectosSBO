...
namespace Soindus.AddOnEmisionDTE.Formularios
{
    ...
    class F65303 : SystemFormBase
    {
        ...
        public static void EnvioDTE(string tipodoc, string folioprefix)
        {
            ...
            {
                case SAPbobsCOM.BoDocumentSubType.bod_DebitMemo:
                    DocSubType = "DN";
                    switch (oDoc.Indicator)
                    {
                        case "11": // ND Exportación
                            tipodoc = "111";
                            folioprefix = "NDX";
                            break;
                        default: // ND Nacional
