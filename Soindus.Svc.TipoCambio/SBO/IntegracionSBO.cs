...
namespace Soindus.Svc.TipoCambio.SBO
{
    public class IntegracionSBO
    {
        public void ObtenerIndicadores(string FechaInicial = "", string FechaFinal = "")
        {
            ...
            //
            SAPbobsCOM.SBObob oSBObob = (SAPbobsCOM.SBObob)SBO.ConexionDIAPI.oCompany.GetBusinessObject(BoObjectTypes.BoBridge);
            ...
            if (_registros.TipoCambiario != null && _registros.TipoCambiario.Count > 0)
            {
                _registros.TipoCambiario.ForEach(x =>
                {
                    ...
                    oRecord = (SAPbobsCOM.Recordset)SBO.ConexionDIAPI.oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
