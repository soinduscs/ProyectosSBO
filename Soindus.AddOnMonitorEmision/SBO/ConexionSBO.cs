...
namespace Soindus.AddOnMonitorEmision.SBO
{
    public class ConexionSBO
    {
        ...
        public ConexionSBO(string[] args)
        {
            ...
            Application.SBO_Application.StatusBar.SetText("Extensión Monitor de Emisión conectada correctamente...", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success);
        }
